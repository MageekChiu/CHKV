...
public class PushMsgHandler extends ChannelOutboundHandlerAdapter {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        ...
        if(msg instanceof WebMsgObject ){//是主动推送，需要编码
            ...
            DataResponse dataResponse =  ((AbstractDataNodeCommand)Class.forName("cn.mageek.common.command.AbstractDataNodeCommand"+webMsgObject.getCommand()).newInstance()).send(webMsgObject);
